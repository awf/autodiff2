...
Mat3x3<Vec3<Real>> /*?*/grad_exp2mat(Vec3<Real> w)
{
  ...
  Mat3x3<Vec3<Real>> ret;

  ret[0][0][0] = -t9*(t23 + t33) - t10*t11*t18*x1;
  ret[0][1][0] = t20 + t21 + t22 - t6*t9*x2 - t10*t19*x1*x3;
  ret[0][2][0] = t25 + t26 + t27 - t6*t9*x3 - t6*t8*x1*x2;

  ret[1][0][0] = -t20 + t21 + t22 + t48 - t6*t9*x2;
  ret[1][1][0] = -t9*(t23 + t32 - t6*x1*2.0) - t10*t11*t24*x1;
  ret[1][2][0] = t28 + t29 + t30 + t31 - t3*t10*t19;

  ret[2][0][0] = -t25 + t26 + t27 + t39 - t6*t9*x3;
  ret[2][1][0] = -t28 - t29 + t30 + t31 + t3*t10*t19;
  ret[2][2][0] = -t9*(t32 + t33 - t6*x1*2.0) - t10*t11*t34*x1;

  ret[0][0][1] = -t9*(t38 + t43 - t6*x2*2.0) - t10*t11*t18*x2;
  ret[0][1][1] = t35 + t36 + t37 - t6*t9*x1 - t10*t19*x2*x3;
  ret[0][2][1] = -t28 + t30 + t31 + t40 - t2*t6*t8;

  ret[1][0][1] = -t35 + t36 + t37 + t45 - t6*t9*x1;
  ret[1][1][1] = -t9*(t38 + t44) - t10*t11*t24*x2;
  ret[1][2][1] = -t25 + t39 + t41 + t42 - t6*t9*x3;

  ret[2][0][1] = t28 + t30 + t31 - t40 + t2*t6*t8;
  ret[2][1][1] = t25 - t39 + t41 + t42 - t6*t9*x3;
  ret[2][2][1] = -t9*(t43 + t44 - t6*x2*2.0) - t10*t11*t34*x2;

  ret[0][0][2] = -t9*(t47 + t54 - t6*x3*2.0) - t10*t11*t18*x3;
  ret[0][1][2] = t28 + t30 + t31 + t46 - t4*t10*t19;
  ret[0][2][2] = -t35 + t45 + t49 + t50 - t6*t9*x1;

  ret[1][0][2] = -t28 + t30 + t31 - t46 + t4*t10*t19;
  ret[1][1][2] = -t9*(t47 + t53 - t6*x3*2.0) - t10*t11*t24*x3;
  ret[1][2][2] = t20 - t48 + t51 + t52 - t6*t9*x2;
