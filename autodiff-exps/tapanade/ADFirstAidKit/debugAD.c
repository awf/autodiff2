...
void debug_adj_rwreal4_(float *vard) {
  debug_adj_rwreal4(vard) ;
}
...
void debug_adj_rreal4_(float *vard) {
  debug_adj_rreal4(vard) ;
}
...
void debug_adj_wreal4_(float *vard) {
  debug_adj_wreal4(vard) ;
}
...
void debug_adj_rwreal4array_(float *vard, int *length) {
  debug_adj_rwreal4array(vard, *length) ;
}
...
void debug_adj_rreal4array_(float *vard, int *length) {
  debug_adj_rreal4array(vard, *length) ;
}
...
void debug_adj_wreal4array_(float *vard, int *length) {
  debug_adj_wreal4array(vard, *length) ;
}
